...
displayResults("#results",resourceData);

var data = 0

function updateData() {
	var svg = d3.select("#results").select("svg").remove();
	displayResults("#results",workflowData);

    // Select the section we want to apply our changes to
    //var bod = d3.select("#timeline").transition();
